...
const NavBar = (props) => {
    ...
    const keywordEntered = (eventValue) => {
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("sports")}>Sport</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("science")}>Science</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("health")}>Health</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("technology")}>Technology</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("entertainment")}>Entertaintment</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.categorySelected("general")}>All</a></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" href="/" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("tr")}>Türkiye</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("us")}>USA</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("fr")}>France</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("gb")}>England</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("it")}>Italy</a></li>
                                    <li><a className="dropdown-item" href="#" onClick={() => props.countrySelected("jp")}>Japan</a></li>
                                </ul>
                            </li>
                        </ul>
                        <form class="d-flex">
                            <input className="form-control me-2" type="search" placeholder="Search for Headlines" aria-label="Search" onChange={(e) => keywordEntered(e.target.value)} />
                            <button className="btn btn-outline-success" onClick={() => props.keywordSearched(keyword)}>Search</button>
                        </form>
                    </div>
                </div>
            </nav>
